...
background = st.text_area('Tell us about yourself. Paste in your resume, or parts of your LinkedIn profile, or write a brief summary. Your name and contact details are not required.')

if background:
    goals = st.text_area('What are your MBA goals? Which schools and programs have captured your attention?')
